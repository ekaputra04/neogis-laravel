...
export default function DialogFilterStreetComponent() {
    ...
    const [kondisiChecks, setKondisiChecks] = useState<Record<string, boolean>>(
        {}
    );
            ...
            <AlertDialogContent className="max-h-[80vh] overflow-y-auto">
                ...
                <div className="gap-4 grid grid-cols-1 md:grid-cols-3 mt-4">
                    ...
                    <div className="">
                        ...
                        {(kondisi as KondisiJalanInterface[]).map((item) => (
                            <div
                                key={item.id}
                                className="flex items-center space-x-2 mt-2"
                            >
                ...
                <AlertDialogFooter>
                    ...
                    <AlertDialogAction
                        onClick={() => {
                            // Logika untuk apply filter
                            console.log("Eksisting selected:", eksistingChecks);
                            console.log("Jenis selected:", jenisChecks);
                            console.log("Kondisi selected:", kondisiChecks);
                        }}
                    >
                        Apply
                    </AlertDialogAction>
